...
const countries_search = ['Republic of the Congo','Germany','Armenia','Guinea Bissau','Nicaragua','Africa','Ireland','Asia','Hungary','Oman','Saudi Arabia','Bosnia and Herzegovina',
...
whenDocumentLoaded(() => {
  ...
  autocomplete(document.getElementById("select_country"), countries_search);
  let submit_button = document.getElementById("submit_search")
